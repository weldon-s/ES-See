...
from rest.predict.viewset import PredictViewSet
...
router.register(r"running_order", RunningOrderViewset, "data-running-order")
...
router.register(r"predict", PredictViewSet, "data-predict")
